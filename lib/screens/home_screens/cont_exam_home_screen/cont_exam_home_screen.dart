...
class ContExamHomeScreen extends StatelessWidget {
  const ContExamHomeScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      //app bar
      appBar: const CustomAppBar(title: CustomStrings.contExamScreenAppBarText),
      //drawer menu
      drawer: UserDrawer(
