...
class ViewCourseInfoScreen extends StatelessWidget {
  const ViewCourseInfoScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(
          title: CustomStrings.viewCourseInfoScreenAppBarText),
              ...
              //if snapshot contains data
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return InkWell(
                      onTap: () {
                        //going to teacher info screen
                        Get.toNamed('/viewTeacherInfoScreen',
                            arguments: FetchDataController.coursesIds[index]);
                      },
                      child: listCard(
